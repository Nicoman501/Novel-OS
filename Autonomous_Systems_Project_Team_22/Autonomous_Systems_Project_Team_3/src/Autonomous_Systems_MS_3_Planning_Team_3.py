...
#######################################################################
#Initialize ROS Node
rospy.init_node('Autonomous_Systems_MS_4_Planning_Team_3') #Identify ROS Node
#######################################################################
...
#sub1 = rospy.Subscriber('/Localization', ModelState, callback_Act_St)
...
while 1 and not rospy.is_shutdown():
 ...
 if(Actual_position.position.x>3):
  V_Des = 0.5
  Lane_Des = -0.5
 if(Actual_position.position.x>6.5):
  V_Des = 1
  Lane_Des = 0.5
